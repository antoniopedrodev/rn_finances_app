...
export function Dashboard() {
    ...
    async function loadTransactions() {
        ...
        const finalResult = entriesTotal - expensiveTotal;
        ...
        setHighlightData({
            ...
            finalResult: {
                total: finalResult.toLocaleString('pt-BR', {
                    style: 'currency',
                    currency: 'BRL'
                }),
                ...
                <>
                    ...
                    <HighlightCards>
                        ...
                        <HighlightCard
                            type="total"  
                            title="Total"
                            amount={highlightData.finalResult.total}
                            lastTransaction={highlightData.finalResult.lastTransaction} 
                        />
                    </HighlightCards>
